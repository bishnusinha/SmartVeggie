...
<div class="container" style="width:960px">
	<form:form method="post" action="createvendoritem.html" commandName="item">
	
	<div class="form-group">
				<label for="outletCode">Outlet Name:</label> 
	...
	<div class="form-group">
				...
				<select id="subOutletCode" class="form-control" name="subOutletCode" size="1" style="width:196px; padding:1px;" >
					<option value='0' selected>Please Select</option>
	...
	<div class="form-group">
			...
			<input id='itemQuanity' class="form-control" type="text" name='itemQuanity' style="width:15%" placeholder="Quantity"/>
